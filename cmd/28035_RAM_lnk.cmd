...
PAGE 0 :
   ...
   RAML2L3       : origin = 0x008C00, length = 0x001400
   //RAML0		: origin = 0x003F800, length = 0x000800
...
SECTIONS
{
   ...
   ramfuncs         : > RAML2L3    PAGE = 0

  //  {
 //  	--library=rts2800_ml.lib<fs_mpy.obj>
 //  	}
   ServiceData		: > RAML0L1      PAGE = 1
   //.text            : > RAML3,   PAGE = 0 //RAML0L1|
   .text            : > RAML2L3,   	PAGE = 0 //RAML0L1|
   .cinit           : > RAML2L3,    PAGE = 0
   .pinit           : > RAMM0,     PAGE = 0
   .switch          : > RAMM0,     PAGE = 0
   ...
   IQmathTables     : > IQTABLES,  PAGE = 0, TYPE = NOLOAD
   	...
   	/* CNTL_2P2Z section */
   	ZeroNet_Section :> RAML0L1 PAGE = 1
   	ADCDRV_1ch_Section :> RAML0L1 PAGE = 1

	CNTL_2P2Z_Section : > RAML0L1 PAGE = 1
	CNTL_2P2Z_InternalData : > RAML0L1 PAGE = 1
	CNTL_2P2Z_Coef : > RAML0L1 PAGE = 1

	MATH_EMAVG_Section				: > RAML0L1				PAGE = 1
	PFC_ICMD_Section				: > RAML0L1				PAGE = 1
	PFC_InvRmsSqr_Section			: > RAML0L1				PAGE = 1

	PWMDRV_1ch_UpDwnCnt_Section : > RAML0L1 PAGE = 1
	PWMDRV_1ch_UpDwnCntCompl_Section : > RAML0L1 PAGE = 1

	ISR_Section :> RAML0L1 PAGE = 1
	SineTableSection :> RAML0L1 PAGE = 1

	SFRA_IQ_Data :> RAML0L1 PAGE = 1
	ISRVariables: > RAML0L1				PAGE = 1
