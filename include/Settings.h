...
#define I_SW_O_THRSHLD_54    _IQ24(((54.0*SQRT2*70.0/2500.0)/1.15)/ADC_REF)         //=0.7437579        1.15 - влияние 1кОм до выпрямителя
#define I_SW_O_THRSHLD_30    _IQ24(((30.0*SQRT2*70.0/2500.0)/1.15)/ADC_REF)         //=0.41319
//I_IN
#define I_IN_THRSHLD_65      _IQ24(((65.0*SQRT2*Kdt)/1.03)/ADC_REF)                 //=0.88532515      1.03 - влияние 5кОм до выпрямителя
